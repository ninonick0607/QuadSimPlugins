...
public:
	...
	{
    	UROS2Utils::StringSequenceROSToUEArray<rosidl_runtime_c__String>(in_ros_data.targets.data, Targets, in_ros_data.targets.size);

		UROS2Utils::SequenceROSToUEArray<ue_msgs__msg__OverlappingObjects, FROSOverlappingObjects>(in_ros_data.overlaps.data, Overlaps, in_ros_data.overlaps.size);
	...
	void SetROS2(ue_msgs__msg__Overlaps& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__String__Sequence__init(&out_ros_data.targets, Targets.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.targets  "));}
		...
		if (!ue_msgs__msg__OverlappingObjects__Sequence__init(&out_ros_data.overlaps, Overlaps.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.overlaps  "));}
		UROS2Utils::ArrayUEToROSSequence<ue_msgs__msg__OverlappingObjects, FROSOverlappingObjects>(Overlaps, out_ros_data.overlaps.data, Overlaps.Num());
