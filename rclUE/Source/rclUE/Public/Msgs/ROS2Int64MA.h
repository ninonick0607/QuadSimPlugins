...
public:
	...
	void SetROS2(example_interfaces__msg__Int64MultiArray& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__int64__Sequence__init(&out_ros_data.data, Data.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.data  "));}
