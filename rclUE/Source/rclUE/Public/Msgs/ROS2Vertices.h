...
public:
	...
	{
    	UROS2Utils::SequenceROSToUEArray<unsigned int, unsigned int>(in_ros_data.vertices.data, Vertices, in_ros_data.vertices.size);
	...
	void SetROS2(pcl_msgs__msg__Vertices& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__uint32__Sequence__init(&out_ros_data.vertices, Vertices.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.vertices  "));}
