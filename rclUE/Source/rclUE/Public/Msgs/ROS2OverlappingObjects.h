...
public:
	...
	void SetFromROS2(const ue_msgs__msg__OverlappingObjects& in_ros_data)
	{
		...
		UROS2Utils::StringSequenceROSToUEArray<rosidl_runtime_c__String>(in_ros_data.components.data, Components, in_ros_data.components.size);
	...
	void SetROS2(ue_msgs__msg__OverlappingObjects& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__String__Sequence__init(&out_ros_data.actors, Actors.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.actors  "));}
		...
		if (!rosidl_runtime_c__String__Sequence__init(&out_ros_data.components, Components.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.components  "));}
