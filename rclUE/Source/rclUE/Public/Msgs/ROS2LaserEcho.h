...
public:
	...
	void SetROS2(sensor_msgs__msg__LaserEcho& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__float32__Sequence__init(&out_ros_data.echoes, Echoes.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.echoes  "));}
