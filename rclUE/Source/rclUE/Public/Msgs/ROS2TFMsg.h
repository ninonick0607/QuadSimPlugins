...
public:
	...
	void SetROS2(tf2_msgs__msg__TFMessage& out_ros_data) const
	{
		...
		if (!geometry_msgs__msg__TransformStamped__Sequence__init(&out_ros_data.transforms, Transforms.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.transforms  "));}
