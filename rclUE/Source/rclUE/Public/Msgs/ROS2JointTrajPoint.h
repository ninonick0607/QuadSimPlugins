...
public:
	...
	void SetFromROS2(const trajectory_msgs__msg__JointTrajectoryPoint& in_ros_data)
	{
		...
		UROS2Utils::SequenceROSToUEArray<double, double>(in_ros_data.accelerations.data, Accelerations, in_ros_data.accelerations.size);
	...
	void SetROS2(trajectory_msgs__msg__JointTrajectoryPoint& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__float64__Sequence__init(&out_ros_data.positions, Positions.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.positions  "));}
		...
		if (!rosidl_runtime_c__float64__Sequence__init(&out_ros_data.accelerations, Accelerations.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.accelerations  "));}
