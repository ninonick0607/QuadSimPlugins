...
public:
	...
	void SetFromROS2(const action_msgs__srv__CancelGoal_Response& in_ros_data)
	{
		...
		UROS2Utils::SequenceROSToUEArray<action_msgs__msg__GoalInfo, FROSGoalInfo>(in_ros_data.goals_canceling.data, GoalsCanceling, in_ros_data.goals_canceling.size);
	...
	void SetROS2(action_msgs__srv__CancelGoal_Response& out_ros_data) const
	{
		...
		if (!action_msgs__msg__GoalInfo__Sequence__init(&out_ros_data.goals_canceling, GoalsCanceling.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.goals_canceling  "));}
		UROS2Utils::ArrayUEToROSSequence<action_msgs__msg__GoalInfo, FROSGoalInfo>(GoalsCanceling, out_ros_data.goals_canceling.data, GoalsCanceling.Num());
