...
public:
	...
	void SetROS2(example_interfaces__action__Fibonacci_GetResult_Response& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__int32__Sequence__init(&out_ros_data.result.sequence, Sequence.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.result.sequence  "));}
...
public:
	...
	void SetROS2(example_interfaces__action__Fibonacci_FeedbackMessage& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__int32__Sequence__init(&out_ros_data.feedback.sequence, Sequence.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.feedback.sequence  "));}
