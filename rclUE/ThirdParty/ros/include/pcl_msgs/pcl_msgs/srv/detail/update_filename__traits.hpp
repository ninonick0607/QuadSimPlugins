...
inline void to_flow_style_yaml(
  const UpdateFilename_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const UpdateFilename_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pcl_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pcl_msgs::srv::UpdateFilename_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  pcl_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pcl_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const pcl_msgs::srv::UpdateFilename_Event & msg)
{
  return pcl_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<pcl_msgs::srv::UpdateFilename_Event>()
{
  return "pcl_msgs::srv::UpdateFilename_Event";
}

template<>
inline const char * name<pcl_msgs::srv::UpdateFilename_Event>()
{
  return "pcl_msgs/srv/UpdateFilename_Event";
}

template<>
struct has_fixed_size<pcl_msgs::srv::UpdateFilename_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<pcl_msgs::srv::UpdateFilename_Event>
  : std::integral_constant<bool, has_bounded_size<pcl_msgs::srv::UpdateFilename_Request>::value && has_bounded_size<pcl_msgs::srv::UpdateFilename_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<pcl_msgs::srv::UpdateFilename_Event>
  : std::true_type {};
