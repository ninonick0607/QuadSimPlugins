...
#ifndef UE_MSGS__SRV__DETAIL__SPAWN_ENTITY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_HPP_
#define UE_MSGS__SRV__DETAIL__SPAWN_ENTITY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_HPP_
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ue_msgs
max_serialized_size_key_SpawnEntity_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ue_msgs
max_serialized_size_key_SpawnEntity_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ue_msgs
cdr_serialize(
  const ue_msgs::srv::SpawnEntity_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ue_msgs::srv::SpawnEntity_Event & ros_message);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ue_msgs
max_serialized_size_key_SpawnEntity_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ue_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ue_msgs, srv, SpawnEntity_Event)();
