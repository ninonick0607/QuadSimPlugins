...
class Init_SpawnWorld_Event_response
{
public:
  explicit Init_SpawnWorld_Event_response(::ue_msgs::srv::SpawnWorld_Event & msg)
  : msg_(msg)
  {}
  ::ue_msgs::srv::SpawnWorld_Event response(::ue_msgs::srv::SpawnWorld_Event::_response_type arg)
  {
...
private:
  ::ue_msgs::srv::SpawnWorld_Event msg_;
};

class Init_SpawnWorld_Event_request
{
public:
  explicit Init_SpawnWorld_Event_request(::ue_msgs::srv::SpawnWorld_Event & msg)
  : msg_(msg)
  {}
  Init_SpawnWorld_Event_response request(::ue_msgs::srv::SpawnWorld_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SpawnWorld_Event_response(msg_);
  }
...
class Init_SpawnWorld_Event_info
{
public:
  Init_SpawnWorld_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SpawnWorld_Event_request info(::ue_msgs::srv::SpawnWorld_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SpawnWorld_Event_request(msg_);
  }
...
template<>
inline
auto build<::ue_msgs::srv::SpawnWorld_Event>()
{
  return ue_msgs::srv::builder::Init_SpawnWorld_Event_info();
}
