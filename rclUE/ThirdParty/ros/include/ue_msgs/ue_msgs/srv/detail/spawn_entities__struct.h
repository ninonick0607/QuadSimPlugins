...
enum
{
  ue_msgs__srv__SpawnEntities_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ue_msgs__srv__SpawnEntities_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SpawnEntities in the package ue_msgs.
typedef struct ue_msgs__srv__SpawnEntities_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ue_msgs__srv__SpawnEntities_Request__Sequence request;
  ue_msgs__srv__SpawnEntities_Response__Sequence response;
} ue_msgs__srv__SpawnEntities_Event;

// Struct for a sequence of ue_msgs__srv__SpawnEntities_Event.
typedef struct ue_msgs__srv__SpawnEntities_Event__Sequence
{
