...
enum
{
  ue_msgs__srv__GetInt32FromId_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ue_msgs__srv__GetInt32FromId_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetInt32FromId in the package ue_msgs.
typedef struct ue_msgs__srv__GetInt32FromId_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ue_msgs__srv__GetInt32FromId_Request__Sequence request;
  ue_msgs__srv__GetInt32FromId_Response__Sequence response;
} ue_msgs__srv__GetInt32FromId_Event;

// Struct for a sequence of ue_msgs__srv__GetInt32FromId_Event.
typedef struct ue_msgs__srv__GetInt32FromId_Event__Sequence
{
