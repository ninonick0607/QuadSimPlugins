...
#ifndef UE_MSGS__SRV__DETAIL__SET_ENTITY_STATE__TYPE_SUPPORT_H_
#define UE_MSGS__SRV__DETAIL__SET_ENTITY_STATE__TYPE_SUPPORT_H_
...
#endif  // UE_MSGS__SRV__DETAIL__SET_ENTITY_STATE__TYPE_SUPPORT_H_
