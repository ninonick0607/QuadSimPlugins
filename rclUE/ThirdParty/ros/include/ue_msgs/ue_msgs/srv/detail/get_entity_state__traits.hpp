...
[[deprecated("use ue_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ue_msgs::srv::GetEntityState_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ue_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ue_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const ue_msgs::srv::GetEntityState_Event & msg)
{
  return ue_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ue_msgs::srv::GetEntityState_Event>()
{
  return "ue_msgs::srv::GetEntityState_Event";
}

template<>
inline const char * name<ue_msgs::srv::GetEntityState_Event>()
{
  return "ue_msgs/srv/GetEntityState_Event";
}

template<>
struct has_fixed_size<ue_msgs::srv::GetEntityState_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ue_msgs::srv::GetEntityState_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<ue_msgs::srv::GetEntityState_Request>::value && has_bounded_size<ue_msgs::srv::GetEntityState_Response>::value> {};

template<>
struct is_message<ue_msgs::srv::GetEntityState_Event>
  : std::true_type {};
