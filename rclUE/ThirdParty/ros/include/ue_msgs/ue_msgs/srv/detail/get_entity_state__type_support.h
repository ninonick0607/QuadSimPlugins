...
#ifndef UE_MSGS__SRV__DETAIL__GET_ENTITY_STATE__TYPE_SUPPORT_H_
#define UE_MSGS__SRV__DETAIL__GET_ENTITY_STATE__TYPE_SUPPORT_H_
...
#endif  // UE_MSGS__SRV__DETAIL__GET_ENTITY_STATE__TYPE_SUPPORT_H_
