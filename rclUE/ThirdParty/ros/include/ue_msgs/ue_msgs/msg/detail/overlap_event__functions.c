...
bool
ue_msgs__msg__OverlapEvent__init(ue_msgs__msg__OverlapEvent * msg)
{
  if (!msg) {
    return false;
  }
...
void
ue_msgs__msg__OverlapEvent__fini(ue_msgs__msg__OverlapEvent * msg)
{
  if (!msg) {
    return;
  }
...
bool
ue_msgs__msg__OverlapEvent__are_equal(const ue_msgs__msg__OverlapEvent * lhs, const ue_msgs__msg__OverlapEvent * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  if (!ue_msgs__msg__HitResult__are_equal(
      &(lhs->sweep_result), &(rhs->sweep_result)))
  {
    return false;
  }
  return true;
...
bool
ue_msgs__msg__OverlapEvent__copy(
  const ue_msgs__msg__OverlapEvent * input,
  ue_msgs__msg__OverlapEvent * output)
{
  ...
  if (!ue_msgs__msg__HitResult__copy(
      &(input->sweep_result), &(output->sweep_result)))
  {
    return false;
  }
  return true;
...
ue_msgs__msg__OverlapEvent__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ue_msgs__msg__OverlapEvent * msg = (ue_msgs__msg__OverlapEvent *)allocator.allocate(sizeof(ue_msgs__msg__OverlapEvent), allocator.state);
  if (!msg) {
    return NULL;
  }
...
void
ue_msgs__msg__OverlapEvent__destroy(ue_msgs__msg__OverlapEvent * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ue_msgs__msg__OverlapEvent__fini(msg);
...
bool
ue_msgs__msg__OverlapEvent__Sequence__init(ue_msgs__msg__OverlapEvent__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
ue_msgs__msg__OverlapEvent__Sequence__fini(ue_msgs__msg__OverlapEvent__Sequence * array)
{
  if (!array) {
    return;
  }
...
ue_msgs__msg__OverlapEvent__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ue_msgs__msg__OverlapEvent__Sequence * array = (ue_msgs__msg__OverlapEvent__Sequence *)allocator.allocate(sizeof(ue_msgs__msg__OverlapEvent__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
void
ue_msgs__msg__OverlapEvent__Sequence__destroy(ue_msgs__msg__OverlapEvent__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
...
bool
ue_msgs__msg__OverlapEvent__Sequence__are_equal(const ue_msgs__msg__OverlapEvent__Sequence * lhs, const ue_msgs__msg__OverlapEvent__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
ue_msgs__msg__OverlapEvent__Sequence__copy(
  ...
  ue_msgs__msg__OverlapEvent__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ue_msgs__msg__OverlapEvent);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ue_msgs__msg__OverlapEvent * data =
      (ue_msgs__msg__OverlapEvent *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ue_msgs__msg__OverlapEvent__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ue_msgs__msg__OverlapEvent__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ue_msgs__msg__OverlapEvent__copy(
