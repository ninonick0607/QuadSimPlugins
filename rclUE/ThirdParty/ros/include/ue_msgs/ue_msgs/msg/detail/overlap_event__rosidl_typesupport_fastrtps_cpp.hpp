...
#ifndef UE_MSGS__MSG__DETAIL__OVERLAP_EVENT__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_HPP_
...
cdr_serialize(
  const ue_msgs::msg::OverlapEvent & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ue_msgs::msg::OverlapEvent & ros_message);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ue_msgs
max_serialized_size_OverlapEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ue_msgs
max_serialized_size_key_OverlapEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ue_msgs, msg, OverlapEvent)();
