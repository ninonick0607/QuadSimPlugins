...
#ifndef UE_MSGS__MSG__DETAIL__OVERLAP_EVENT__TYPE_SUPPORT_H_
#define UE_MSGS__MSG__DETAIL__OVERLAP_EVENT__TYPE_SUPPORT_H_
...
#endif  // UE_MSGS__MSG__DETAIL__OVERLAP_EVENT__TYPE_SUPPORT_H_
